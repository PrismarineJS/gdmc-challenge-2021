...
function drawColor (data, palette) {
...
async function saveColor (path, data, palette) {
  const canvas = drawColor(data, palette)
...
module.exports = { preloadWorld, saveBiomes, saveColor, saveGrayscale, drawColor }
